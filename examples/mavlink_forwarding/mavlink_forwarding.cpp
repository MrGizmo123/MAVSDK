...
int main(int, char**)
{
    ...
    ConnectionResult connection_result =
        mavsdk.add_any_connection("udpout://127.0.0.1:12550", ForwardingOption::ForwardingOn);
    ...
    connection_result =
        mavsdk.add_any_connection("udpout://10.41.10.2:14550", ForwardingOption::ForwardingOn);
    if (connection_result != ConnectionResult::Success) {
